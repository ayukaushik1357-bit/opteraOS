...
export const mockCustomers: MockCustomer[] = [
  ...
  },
  {
    id: "c3",
    name: "Farah Sheikh",
    company: "Bluewave Interiors",
    email: "farah@bluewave.design",
  ...
  },
  {
    ...
    email: "sana@aurumjewels.in",
    phone: "+91 93110 66234",
    status: "churned",
    value: 96000,
    city: "Delhi",
  ...
  },
  {
    id: "c6",
    name: "Dev Patel",
    company: "Sunhaven Realty",
    email: "dev@sunhaven.co.in",
    phone: "+91 97690 33045",
    status: "prospect",
    value: 340000,
    city: "Ahmedabad",
  ...
  },
  {
    id: "c7",
    name: "Meera Iyer",
    company: "Kavya Analytics",
    email: "meera@kavya.ai",
    phone: "+91 89390 55001",
    status: "active",
    value: 498000,
    city: "Chennai",
  ...
  },
  {
    id: "c8",
    name: "Arjun Sethi",
    company: "Tempo Sportswear",
    email: "arjun@temposport.in",
    phone: "+91 90112 87766",
    status: "active",
    value: 265000,
    city: "Jaipur",
...
export const mockLeads: MockLead[] = [
  {
    id: "l1",
    name: "Karthik Menon",
    company: "Vertex Auto Parts",
    email: "karthik@vertexauto.in",
    source: "Website",
    score: 88,
    stage: "qualified",
    owner: "Priya S.",
  ...
  },
  {
    id: "l3",
    name: "Imran Qureshi",
    company: "Skyline Pharma",
    email: "imran@skylinepharma.in",
    source: "Referral",
    score: 91,
    stage: "qualified",
    owner: "Priya S.",
  ...
  },
  {
    id: "l4",
    name: "Tara Bose",
    company: "Hearth Cafes",
    email: "tara@hearthcafes.in",
    source: "Campaign",
    score: 52,
    stage: "new",
    owner: "Unassigned",
  ...
  },
  {
    id: "l6",
    name: "Ritu Sharma",
    company: "Elan Wellness",
    email: "ritu@elanwellness.in",
    source: "Website",
    score: 67,
    stage: "contacted",
    owner: "Neha K.",
...
export const mockDeals: MockDeal[] = [
  ...
  {
    id: "d6",
    title: "Franchise pilot",
    customer: "Hearth Cafes",
    value: 98000,
    stage: "lost",
    owner: "Rahul D.",
...
export const mockInvoices: MockInvoice[] = [
  {
    ...
    status: "sent",
    items: [
      { description: "Growth plan — August", qty: 1, rate: 149500 },
      { description: "Onboarding support", qty: 5, rate: 7000 },
    ],
  },
  {
    id: "i2",
    ...
    status: "overdue",
    items: [
      { description: "Starter plan — July", qty: 1, rate: 52400 },
      { description: "Extra seats", qty: 2, rate: 5000 },
    ],
  },
  {
    id: "i3",
    ...
    amount: 271000,
    status: "paid",
    items: [{ description: "Business plan — annual", qty: 1, rate: 271000 }],
  },
  {
    id: "i4",
    ...
    amount: 58800,
    status: "draft",
    items: [{ description: "Analytics add-on", qty: 1, rate: 58800 }],
  },
  {
    id: "i5",
    ...
    amount: 24900,
    status: "paid",
    items: [{ description: "Starter plan — July", qty: 1, rate: 24900 }],
  },
];
...
export const mockPayments: MockPayment[] = [
  ...
  {
    id: "p5",
    reference: "pay_QhM7c3Ws",
    customer: "Aurum Jewels",
    method: "Card",
    amount: 18000,
    status: "failed",
    paidAt: "2026-08-01",
...
export const mockAiInsights = [
  {
    id: "a1",
    title: "Repeat purchases down 22%",
    detail: "37 high-value customers haven't purchased in 60+ days. Estimated opportunity ₹4.8L.",
    action: "Create re-engagement campaign",
  },
  {
    id: "a2",
    title: "2 SKUs will stock out this week",
    detail: "Trail Runner Shoes and Insulated Bottle fall below reorder point at current velocity.",
    action: "Draft purchase order",
  },
  {
    id: "a3",
    title: "₹2.48L invoices past due",
    detail: "12 invoices are overdue by more than 7 days across 6 customers.",
...
export const mockAutomationActivity = [
  ...
  },
  {
    ...
    ranAt: "18 min ago",
    status: "success" as const,
    detail: "12 reminders sent on WhatsApp",
  },
  {
    id: "r3",
    ...
    detail: "8 alerts routed to purchasing",
  },
  {
    id: "r4",
    ...
    detail: "1 payment awaiting webhook verification",
  },
];
...
export const mockAutomations = [
  ...
  {
    id: "w2",
    name: "Order → invoice → confirmation",
...
export const mockIntegrations = [
  {
    ...
    name: "Razorpay",
    category: "Payments",
    desc: "Collect payments, subscriptions and settlements.",
  },
  {
    id: "whatsapp",
    name: "WhatsApp",
    category: "Communication",
    desc: "Send templated messages and follow-ups to customers.",
  },
  {
    id: "email",
    name: "Email",
  ...
  },
  {
    ...
    desc: "Calendar, Sheets and Drive sync for your team.",
  },
  {
    id: "webhooks",
    name: "Webhooks",
    category: "Developer",
    desc: "Push business events to any external endpoint.",
  },
  {
    id: "n8n",
    name: "n8n",
    category: "Automation",
    desc: "Extend workflows with a managed execution layer.",
  },
  {
    id: "rest",
    name: "REST API",
    category: "Developer",
    desc: "Programmatic access to every opteraOS resource.",
  },
];
