...
--    DROP first: Postgres disallows changing a function's return type via
--    CREATE OR REPLACE (SQLSTATE 42P13). Dropping and recreating is the fix.
...
GRANT EXECUTE ON FUNCTION public.match_document_chunks(vector, float, int, uuid) TO service_role;
