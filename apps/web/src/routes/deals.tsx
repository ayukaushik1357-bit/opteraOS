...
const description =
  "Track every deal from lead to won across a live sales pipeline with values, owners and close dates.";
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Move deals through stages and watch the overview update live.
          </p>
        </div>
            ...
            <div className="grid gap-4">
              ...
              <div className="grid gap-2">
                ...
                <Select
                  ...
                  onValueChange={(v) => setDraft({ ...draft, customerId: v === "none" ? "" : v })}
                >
                  <SelectTrigger>
                  ...
                  {items.map((d) => (
                    <li key={d.id} className="rounded-xl bg-secondary/40 p-3">
                      ...
                      <p className="text-xs text-muted-foreground">
                        Close {shortDate(d.expected_close)}
                      </p>
                      <div className="mt-2 flex items-center gap-1">
                        <Select
                          value={d.stage}
                          onValueChange={(v) =>
                            stageMutation.mutate({ id: d.id, stage: v as Stage })
                          }
                        >
