...
/* ── Section ambient glow helper ── */
function SectionGlow({ color = "teal" }: { color?: "teal" | "violet" | "cyan" }) {
  const colors = {
    teal: "bg-[#008080]",
    violet: "bg-[#8B5CF6]",
    cyan: "bg-[#22D3EE]",
...
const fragmented = [
  "CRM", "Invoices", "Payments", "Inventory", "Email",
  "WhatsApp", "Analytics", "Marketing", "Automation",
];

export function ProblemSection() {
  return (
    <section className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 overflow-hidden">
      <SectionGlow color="violet" />
      <SectionHeading
        eyebrow="The problem"
...
const modules = [
  { icon: Users, name: "CRM", desc: "Manage leads, customers, contacts, activities and sales pipelines.", color: "text-[#008080]", bg: "bg-[rgba(0,128,128,0.12)] border-[rgba(0,128,128,0.2)]" },
  { icon: Handshake, name: "Sales", desc: "Track opportunities, deals, quotations, orders and revenue.", color: "text-[#22D3EE]", bg: "bg-[rgba(34,211,238,0.12)] border-[rgba(34,211,238,0.2)]" },
  { icon: FileText, name: "Invoices", desc: "Create professional invoices and track payment status.", color: "text-[#8B5CF6]", bg: "bg-[rgba(139,92,246,0.12)] border-[rgba(139,92,246,0.2)]" },
  { icon: CreditCard, name: "Payments", desc: "Manage invoice receivables and automated collections.", color: "text-[#10B981]", bg: "bg-[rgba(16,185,129,0.12)] border-[rgba(16,185,129,0.2)]" },
  { icon: Boxes, name: "Inventory", desc: "Track products, stock levels, low-stock alerts and movements.", color: "text-[#F59E0B]", bg: "bg-[rgba(245,158,11,0.12)] border-[rgba(245,158,11,0.2)]" },
  { icon: BarChart3, name: "Analytics", desc: "Understand revenue, sales, customers and product performance.", color: "text-[#22D3EE]", bg: "bg-[rgba(34,211,238,0.12)] border-[rgba(34,211,238,0.2)]" },
  { icon: Megaphone, name: "Marketing", desc: "Campaigns, customer segments and automated follow-ups.", color: "text-[#F43F5E]", bg: "bg-[rgba(244,63,94,0.12)] border-[rgba(244,63,94,0.2)]" },
  { icon: Workflow, name: "Automation", desc: "Visual workflows connecting business events, AI and services.", color: "text-[#008080]", bg: "bg-[rgba(0,128,128,0.12)] border-[rgba(0,128,128,0.2)]" },
  { icon: Sparkles, name: "AI Assistant", desc: "Ask about your business and let AI execute approved actions.", color: "text-[#8B5CF6]", bg: "bg-[rgba(139,92,246,0.12)] border-[rgba(139,92,246,0.2)]" },
];
...
export function AiSection() {
  ...
  return (
    <section id="ai" className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 overflow-hidden">
            ...
            <div className="max-w-[95%] rounded-2xl rounded-bl-xs border border-[rgba(0,128,128,0.14)] bg-[rgba(22,35,64,0.8)] p-4 text-sm shadow-sm">
              ...
              <div className="mt-4 flex flex-wrap gap-2.5">
                <Button
                  ...
                  className="bg-gradient-to-r from-[#008080] to-[#0D9488] text-white border-0 hover:from-[#006666] hover:to-[#008080] font-semibold text-xs shadow-[0_0_12px_rgba(0,128,128,0.3)]"
                >
                  Review Campaign
                </Button>
                <Button
...
export function AnalyticsSection() {
  return (
    <section id="analytics" className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 overflow-hidden">
      <SectionGlow color="teal" />
      <SectionHeading
        eyebrow="Analytics"
        ...
        {[
          {
            ...
            color: "text-[#008080]",
            bg: "bg-[rgba(0,128,128,0.12)] border-[rgba(0,128,128,0.2)]",
          },
          {
            icon: Activity,
            t: "Cohorts & retention",
            ...
            color: "text-[#22D3EE]",
            bg: "bg-[rgba(34,211,238,0.12)] border-[rgba(34,211,238,0.2)]",
          },
          {
            icon: Sparkles,
            t: "AI explanations",
...
const integrations = [
  { icon: CreditCard, name: "Invoicing & Billing", cat: "Finance", color: "text-[#10B981]" },
  { icon: Workflow, name: "Automation Engine", cat: "Automation", color: "text-[#008080]" },
  { icon: MessageSquare, name: "WhatsApp Business", cat: "Communication", color: "text-[#22D3EE]" },
  { icon: Activity, name: "Email SMTP & Webhooks", cat: "Marketing", color: "text-[#8B5CF6]" },
  { icon: Building2, name: "Google Workspace", cat: "Productivity", color: "text-[#F59E0B]" },
  { icon: Plug, name: "Custom Webhooks & REST", cat: "Developer", color: "text-[#F43F5E]" },
];

export function IntegrationsSection() {
  const [connect, setConnect] = useState<string | null>(null);
  return (
    <section id="integrations" className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 overflow-hidden">
      <SectionGlow color="cyan" />
      <SectionHeading
...
export function PricingSection({ id }: { id?: string }) {
  ...
  return (
    <section id={id} className="relative container mx-auto px-4 py-20 overflow-hidden">
      <SectionGlow color="teal" />
      <SectionHeading
        eyebrow="Access"
        title="Direct Enterprise Platform Access"
        subtitle="opteraOS is fully open and directly accessible for your business without subscription paywalls."
      />
...
export function FaqSection() {
  return (
    <section id="faq" className="relative mx-auto max-w-3xl px-4 py-20 sm:px-6 overflow-hidden">
